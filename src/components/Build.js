  ...
  <div className="build">
    <div className="build__box">
      <div className="build__box-row">
        <div className="build__cover">{/* Cover image and decorations */}</div>
        <div className="build__main">
          <div className="build__main-title">
            Create an impressive brand on schedule and within budget
          </div>
          <div className="build__main-note">
            Kickstart your business with thousands of expert resources.{" "}
            <b>ready-to-use</b> design assets.
          </div>
          <div className="build__main-list">{/* List of items */}</div>
